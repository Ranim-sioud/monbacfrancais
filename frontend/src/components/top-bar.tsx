      ...
      <div className={`mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 transition-all duration-300 ${isScrolled ? "py-1" : "py-2"}`}>
        <div className="flex flex-col items-center justify-between gap-2 sm:flex-row sm:gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-xs sm:text-sm font-medium">
            <a href="mailto:contact@monbacfrancais.com" className="flex items-center gap-2 hover:text-[var(--primary-blue)] transition">
              <svg className="h-4 w-4 text-[var(--primary-blue)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              contact@monbacfrancais.com
            </a>
            <a href="https://wa.me/+33619684699" className="flex items-center gap-2 hover:text-[var(--primary-blue)] transition">
              <svg className="h-4 w-4 text-[#25D366]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
