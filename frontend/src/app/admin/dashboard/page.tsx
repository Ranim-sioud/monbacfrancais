...
export default function AdminDashboardPage() {
  ...
  return (
    <AdminGuard>
      {/* Welcome */}
      <div className="mb-8 rounded-[2rem] border border-[var(--border-color)] bg-[linear-gradient(160deg,rgba(255,255,255,0.97),rgba(234,244,255,0.94))] p-6 shadow-[0_16px_40px_rgba(1, 48, 120,0.10)]">
      ...
      <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {[
          ...
          <Link
            key={card.title}
            href={card.href}
            className="group rounded-[1.8rem] border border-[var(--border-color)] bg-[linear-gradient(160deg,rgba(255,255,255,0.96),rgba(234,244,255,0.92))] p-7 shadow-[0_10px_28px_rgba(1, 48, 120,0.08)] transition hover:translate-y-[-2px] hover:shadow-[0_16px_40px_rgba(1, 48, 120,0.14)]"
          >
