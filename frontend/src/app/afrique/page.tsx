    ...
    <section className="mx-auto w-full max-w-7xl pt-6 px-4 pb-8 sm:px-6 lg:px-8">
      <div className={`grid gap-6 ${agences.length === 1 ? "grid-cols-1 max-w-xl mx-auto" : "lg:grid-cols-2"}`}>
        {agences.map((a) => {
          ...
          return (
            <article key={a.id} className="rounded-[2rem] border border-[var(--border-color)] bg-white p-6 shadow-[0_14px_36px_rgba(1, 48, 120,0.12)]">
            ...
            <div className="rounded-[2.2rem] border border-[var(--border-color)] bg-[linear-gradient(160deg,rgba(255,255,255,0.97),rgba(234,244,255,0.93))] p-8 shadow-[0_16px_44px_rgba(1, 48, 120,0.14)] sm:p-10">
              ...
              <div className="mt-10 grid gap-6 lg:grid-cols-3">
                {features.map((f, idx) => {
                  ...
                  if (f.variant === "cyan") {
                    cardClass = "rounded-[1.8rem] border border-[var(--primary-blue)]/40 bg-[linear-gradient(160deg,rgba(1, 48, 120,0.15),rgba(255,255,255,0.98))] p-6";
